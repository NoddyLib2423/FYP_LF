...
def modelFOOTWEAR_(df_FOOTWEAR):
    df=df_FOOTWEAR
    ...
    rowcount  = 0
    for row in open("csv/FOOTWEAR_outlier_dataset.csv"):
        rowcount+= 1
    ...
    loaded_model=pickle.load(open("model/xgboostFootwear.dat","rb"))
    # print("Loaded model from:xgboostFootwear.dat")
    ...
    return sum,graph,df_pred1,prediction