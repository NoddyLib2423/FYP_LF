    ...
    with tab1:
        ...
        #Appearl
            if option == 'Appearl':
                ...
                sum,graph,df_pred1,prediction = modelappearl(df_appearl)
                st.plotly_chart(sum)
        ...
        #Equipment
                ...
                sum,graph,df_pred1,prediction = modelEQUIPMENT(df_EQUIPMENT)
                st.plotly_chart(sum)
                if (df_pred1['Predicted'].sum()-df_pred1['Actual'].sum())<0:
                    st.write("we have",((df_pred1['Predicted'].sum()-df_pred1['Actual'].sum())/df_pred1['Predicted'].sum())*(-100), "% of opportunity lost will happen by this model.")
                else:
        ...
        #Footwear
                ...
                sum,graph,df_pred1,prediction = modelFOOTWEAR_(df_FOOTWEAR)
                st.plotly_chart(sum)
                if (df_pred1['Predicted'].sum()-df_pred1['Actual'].sum())<0:
                    st.write("we have",((df_pred1['Predicted'].sum()-df_pred1['Actual'].sum())/df_pred1['Predicted'].sum())*(-100), "% of opportunity lost will happen by this model.")
                else:
    ...
    with tab2:
        ...
        if len(uploaded_data) >0:
            ...
            if option == 'STD':
                ...
                sum,graph,df_pred1,prediction = modelSTD(df_STD)
                st.plotly_chart(sum)
                if (df_pred1['Predicted'].sum()-df_pred1['Actual'].sum())<0:
                    st.write("we have",((df_pred1['Predicted'].sum()-df_pred1['Actual'].sum())/df_pred1['Predicted'].sum())*(-100), "% of opportunity lost will happen by this model.")
                else:
         ...
         #Others
                ...
                sum,graph,df_pred1,prediction = modelOthers(df_others)
                st.plotly_chart(sum)
                if (df_pred1['Predicted'].sum()-df_pred1['Actual'].sum())<0:
                    st.write("we have",((df_pred1['Predicted'].sum()-df_pred1['Actual'].sum())/df_pred1['Predicted'].sum())*(-100), "% of opportunity lost will happen by this model.")
                else:
